...
class PLAYER:
	def __init__(self):
		...
		self.head_up = pygame.image.load('Snake-main/Graphics/head_up_red.png').convert_alpha()
		self.head_down = pygame.image.load('Snake-main/Graphics/head_down_red.png').convert_alpha()
		self.head_right = pygame.image.load('Snake-main/Graphics/head_right_red.png').convert_alpha()
		self.head_left = pygame.image.load('Snake-main/Graphics/head_left_red.png').convert_alpha()
		
		self.tail_up = pygame.image.load('Snake-main/Graphics/tail_up_red.png').convert_alpha()
		self.tail_down = pygame.image.load('Snake-main/Graphics/tail_down_red.png').convert_alpha()
		self.tail_right = pygame.image.load('Snake-main/Graphics/tail_right_red.png').convert_alpha()
		self.tail_left = pygame.image.load('Snake-main/Graphics/tail_left_red.png').convert_alpha()

		self.body_vertical = pygame.image.load('Snake-main/Graphics/body_vertical_red.png').convert_alpha()
		self.body_horizontal = pygame.image.load('Snake-main/Graphics/body_horizontal_red.png').convert_alpha()

		self.body_tr = pygame.image.load('Snake-main/Graphics/body_tr_red.png').convert_alpha()
		self.body_tl = pygame.image.load('Snake-main/Graphics/body_tl_red.png').convert_alpha()
		self.body_br = pygame.image.load('Snake-main/Graphics/body_br_red.png').convert_alpha()
		self.body_bl = pygame.image.load('Snake-main/Graphics/body_bl_red.png').convert_alpha()
